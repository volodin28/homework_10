...
from .exchange_provider import MonoExchange, PrivatExchange, NBUExchange, OschadbankExchange, KredoBankExchange
...
def start_exchange(vendor, currency_a, currency_b):
    ...
    elif vendor == "oschadbank":
        exchange = OschadbankExchange(vendor, currency_a, currency_b)
    elif vendor == "kredobank":
        exchange = KredoBankExchange(vendor, currency_a, currency_b)
    exchange.get_rate()
